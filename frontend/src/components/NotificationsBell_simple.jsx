    ...
    <>
      ...
      <div className="relative">
        ...
        <button
          ...
          className={`relative p-2 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 rounded-full transition-all duration-200 ${
            unreadCount > 0 
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 h-5 w-5 bg-red-500 text-white text-xs rounded-full flex items-center justify-center animate-pulse shadow-lg ring-2 ring-red-200">
            ...
            <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 z-20">
              ...
              {recentNotifications.length > 0 && (
                <div className="p-4 border-t border-gray-200">
                  <a
                    href="/notificaciones"
                    className="block w-full text-center text-sm text-indigo-600 hover:text-indigo-500 font-medium transition-colors"
                  >
